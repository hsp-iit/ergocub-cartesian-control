...
public:
     ...
     * @param joint_vel_weight The weight used in the minimization of the QP functional for the joint velocities term.
    ...
    virtual void set_robot_state(
        ...
        const Eigen::Ref<const Eigen::MatrixXd> &jacobian) override;
...
private:
    ...
    Eigen::VectorXd joints_vel_;

    Eigen::VectorXd joints_lower_limits_;

    Eigen::VectorXd joints_upper_limits_;

    Eigen::VectorXd joints_limits_gains_;
    ...
    const Eigen::VectorXd joint_vel_weight_;

...
namespace
{
    YARP_LOG_COMPONENT(SERVICE_LOG_COMPONENT, "ergoCubCartesianService")
}

//ergoCubCartesianService_getRemoteProtocolVersion_helper declaration
class ergoCubCartesianService_getRemoteProtocolVersion_helper :
public yarp::os::Portable
{
public:
    ergoCubCartesianService_getRemoteProtocolVersion_helper() = default;
...
bool ergoCubCartesianService_getRemoteProtocolVersion_helper::write(yarp::os::ConnectionWriter& connection) const
{
...
bool ergoCubCartesianService_getRemoteProtocolVersion_helper ::read(yarp::os::ConnectionReader & connection)
 {
...
yarp::os::ApplicationNetworkProtocolVersion ergoCubCartesianService::getRemoteProtocolVersion()
 {
    if(!yarp().canWrite()) {
        yError(" Missing server method ergoCubCartesianService::getRemoteProtocolVersion");
    }
    ergoCubCartesianService_getRemoteProtocolVersion_helper helper{};
...
//ProtocolVersion, client side
bool ergoCubCartesianService::checkProtocolVersion()
 {
...
yarp::os::ApplicationNetworkProtocolVersion ergoCubCartesianService::getLocalProtocolVersion()
{
